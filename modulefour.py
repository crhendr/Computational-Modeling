# -*- coding: utf-8 -*-
"""
Created on Thu Apr  6 14:29:44 2017
...
def dla(total_cluster_pts, lattice_bounds):
    ...
    while cluster_pts < total_cluster_pts:
        ...
        for num_moves in range(1000): #number of times random particle moves before being terminated = assumption
...
#    ImageGrab.grab()
#    img.save('snap'+str(time)+'.jpg','JPEG')
#    time+=1
